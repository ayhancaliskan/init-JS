odoo.define("exo_website.actor_app", function (require) {
  ...
  sAnimation.registry.actor_app = Widget.extend({
    ...
    init: function (parent) {
      ...
      this.actor = [];   //iniatilise un [] vide pour chopper les actors dans la fonction _actorsList
  },
    start: function () {
      this._actorsList();
    ...
    _actorsList: function () {
      ...
      this.actors = actorsTable.actors   //avant de rendre le tableau avec la liste des actors, je stock les actors dans u
    ...
    _actorPreview: function (ev) {
      ...
      var actor = _.where(this.actors, {id: actor_id});
      console.log(actor);
      console.log('preview');
    }
  });
